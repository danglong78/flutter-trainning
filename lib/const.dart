...
import 'package:demo_retrofit_moor/thread_pool.dart';
import 'package:dio/dio.dart';

import 'data/api/api_interceptor.dart';

const clientID = "14020af93f18035";

const poolSize = 3;

final uploadThreadPool = ThreadPool(UploadService.instance.uploadImage);

getDio() {
  final Dio dioAPI = Dio(BaseOptions(
    connectTimeout: 5000,
    receiveTimeout: 5000,
    sendTimeout: 5000,
  ));
  dioAPI.interceptors.add(ApiInterceptor(dioAPI));
  return dioAPI;
}
